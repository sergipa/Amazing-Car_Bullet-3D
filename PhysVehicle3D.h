...
struct VehicleInfo
{
	...
	vec3 chassis_mid_size;
	vec3 chassis_mid_offset;
	vec3 chassis_left_size;
	vec3 chassis_left_offset;
	vec3 chassis_right_size;
	vec3 chassis_right_offset;
	vec3 aileron_mid_size;
	vec3 aileron_mid_offset;
	vec3 aileron_left_size;
	vec3 aileron_left_offset;
	vec3 aileron_right_size;
	vec3 aileron_right_offset;
	vec3 upPart_mid_size;
	vec3 upPart_mid_offset;
	vec3 upPart_left_size;
	vec3 upPart_left_offset;
	vec3 upPart_right_size;
	vec3 upPart_right_offset;
	vec3 exhaust_pipe_left_size;
	vec3 exhaust_pipe_left_offset;
	vec3 exhaust_pipe_right_size;
	vec3 exhaust_pipe_right_offset;
	vec3 window_size;
	vec3 window_offset;
	vec3 left_focus_offset;
	vec3 right_focus_offset;
